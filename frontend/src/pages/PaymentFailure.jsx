    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <div className="space-y-2 text-sm">
              ...
              {paymentData.message && (
                <div className="mt-2">
                  ...
                  <p className="text-red-600 text-sm mt-1">{paymentData.message}</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-3">
          <Link
            to="/checkout"
            className="flex items-center justify-center w-full px-6 py-3 text-white rounded-md font-semibold transition"
